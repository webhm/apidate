    ...
    public function getMedicos()
    {
        ...
        try {
            ...
            if ($_searchField != false) {
                ...
                $sql = " SELECT a.cd_prestador, a.nm_prestador
                FROM prestador a, tip_presta b
                WHERE a.cd_tip_presta BETWEEN 40 AND 48 AND
                a.cd_tip_presta = b.cd_tip_presta AND a.nm_prestador LIKE '%" . $this->searchField . "%' ";
            }
    ...
    public function getItems()
    {
        ...
        try {
            ...
            if ($_searchField != false) {
                ...
                $sql = "  SELECT a.CD_ITEM_AGENDAMENTO, a.DS_ITEM_AGENDAMENTO, to_char(a.hr_realizacao, 'HH24:MI') as DURACION, c.ds_sigla_modalidade modalidad
                FROM item_agendamento a, exa_rx b, modalidade_exame c
                WHERE a.sn_ativo = 'S' AND
                a.cd_exa_rx = b.cd_exa_rx AND
                b.cd_modalidade_exame = c.cd_modalidade_exame AND 
                c.ds_sigla_modalidade = 'ES' AND
                DS_ITEM_AGENDAMENTO LIKE '%$this->searchField%'  ";
            }
